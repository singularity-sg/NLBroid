...
public class Query<T> implements Iterable<T> {
	...
	public void addHeader(Form extraHeader){

		String targetUri = createTargetUri();
		resource = this.service.createResource(new Reference(targetUri));
		resource.getRequest().getAttributes().put("org.restlet.http.headers", extraHeader);
